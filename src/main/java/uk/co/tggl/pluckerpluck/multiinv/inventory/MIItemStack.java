 ...
 */
public final class MIItemStack {
    ...
    private String getItemMetaSerialized(ItemMeta meta) {
        ...
        smeta.append("NM#");
        smeta.append("N").append(base64Encode(meta.getDisplayName())).append("#");
        smeta.append("L").append(encodeLore(meta.getLore())).append("#");
        if(meta instanceof SkullMeta) {
            SkullMeta skullmeta = (SkullMeta) meta;
            if(((SkullMeta) meta).hasOwner()) {
                smeta.append("O").append(skullmeta.getOwner()).append("#");
            }
        } else if(meta instanceof LeatherArmorMeta) {
            Color color = ((LeatherArmorMeta) meta).getColor();
            smeta.append("C").append(String.valueOf(color.asRGB())).append("#");
        } else if(meta instanceof PotionMeta) {
            if(((PotionMeta) meta).hasCustomEffects()) {
                List<PotionEffect> effects = ((PotionMeta) meta).getCustomEffects();
                for(PotionEffect effect : effects) {
                    smeta.append("P").append(effect.getType().getName()).append("+").append(effect.getAmplifier()).append("+").append(effect.getDuration()).append("#");
                }
            }
            ...
            if(emeta.hasStoredEnchants()) {
                ...
                for(Entry<Enchantment,Integer> enchant : enchants) {
                    smeta.append("E").append(enchant.getKey().getName()).append("+").append(enchant.getValue().toString()).append("#");
                }
            }
            ...
            for(FireworkEffect effect : effects) {
                ...
                smeta.append("F").append(effect.getType().name()).append("+").append(colorstring.toString()).append("+").append(fadecolorstring.toString()).append("+").append(effect.hasFlicker()).append("+").append(effect.hasTrail()).append("#");
            }
            smeta.append("G").append(Integer.toString(((FireworkMeta) meta).getPower())).append("#");
        ...
        if(meta instanceof Repairable) {
            ...
            smeta.append("R").append(rmeta.getRepairCost());
        }
    ...
    private LinkedList<String> decodeLore(String lore) {
        ...
        for (String slore1 : slore) {
            lstring.add(base64Decode(slore1));
        }
        return lstring;
    }
}
